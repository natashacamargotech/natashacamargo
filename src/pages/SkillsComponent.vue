<template>
  <q-page>
    <div class="bg-pink">
      ...
      <div class="q-pa-md">
        <div href="#skills">
          <h2 class="text-center text-black">Hard Skilss</h2>
        </div>
              ...
              >
                ...
                <q-item clickable v-ripple>
                  ...
                  <q-tooltip>
                    ...
                    em alto nível com tipagem dinâmica fraca e
              ...
              >
                ...
                <q-item clickable v-ripple>
                  ...
                  <q-tooltip
                    ...
                    desenvolvimento de interfaces de usuário e aplicativos de
                    página única</q-tooltip
                  >
                </q-item>
                ...
                <q-item clickable v-ripple>
                  ...
                  <q-tooltip
                    >Plataforma de aplicações web de código-fonte aberto e
                    front-end baseado em TypeScrip</q-tooltip
                  >
                </q-item>
              </q-list>
            </div>
            ...
            <div class="q-pa-md" style="max-width: 350px">
              ...
              >
                ...
                <q-item clickable v-ripple>
                  ...
                  <q-tooltip>
                    Framework de desenvolvimento front-end de código aberto
                    baseado no Vue. js</q-tooltip
                  >
                </q-item>
                ...
                <q-item clickable v-ripple>
                  ...
                  <q-tooltip
                    >Framework web com código-fonte aberto para desenvolvimento
                    de componentes de interface e front-end para sites e
                    aplicações web, usando HTML, CSS e JavaScript</q-tooltip
                  >
                </q-item>
                <q-item clickable v-ripple>
          ...
          <div class="q-pa-md" style="max-width: 350px">
            ...
            >
              ...
              <q-item clickable v-ripple>
                ...
                <q-tooltip
                  >Banco de dados para armazenamento, recuperação e
                  gerenciamento de informações orientadas a
                  documentos</q-tooltip
                >
              </q-item>
              ...
              <q-item clickable v-ripple>
                ...
                <q-tooltip
                  >Ferramenta gráfica que aprimora a produtividade e simplifica
                  as tarefas de modelagem de dados.</q-tooltip
                >
              </q-item>
            </q-list>
          </div>
          ...
          <div class="q-pa-md" style="max-width: 350px">
            ...
            >
              ...
              <q-item clickable v-ripple>
                ...
                <q-tooltip>
                  Maximiza a produtividade administrativa ao facilitar a
                  manutenção e atualização das suas implantações</q-tooltip
                >
              </q-item>
            </q-list>
          </div>
            ...
            >
              ...
              <q-item clickable v-ripple>
                ...
                <q-tooltip
                  ...
                  qualquer tipo de projeto, fluxo de trabalho ou monitoramento
                  de tarefas</q-tooltip
                >
              </q-item>
          ...
          <div class="q-pa-md" style="max-width: 350px">
            ...
            >
              ...
              <q-item clickable v-ripple>
                ...
                <q-tooltip
                  >Plataforma de hospedagem de código-fonte e arquivos com
                  controle de versão usando o Git</q-tooltip
                >
              </q-item>
      ...
      <div class="row bg-pink">
        <div class="col">
          <div href="#skills">
            <h2 class="text-center text-black">Soft Skilss</h2>
          </div>
          <q-list>
            <q-item>
              <q-item-section avatar>
                <q-icon color="black" name="fa-regular fa-heart" />
              </q-item-section>

              <q-item-section>Resilência</q-item-section>
            </q-item>
            <q-item>
              <q-item-section avatar>
                <q-icon color="black" name="fa-regular fa-heart" />
            ...
            <q-item>
              ...
              <q-item-section>Trabalho em Equipe</q-item-section>
            </q-item>
            <q-item>
              <q-item-section avatar>
                <q-icon color="black" name="fa-regular fa-heart" />
              ...
              <q-item-section>Empatia</q-item-section>
            </q-item>
            <q-item>
              <q-item-section avatar>
                <q-icon color="black" name="fa-regular fa-heart" />
            ...
            <q-item>
              ...
              <q-item-section>Criatividade</q-item-section>
            </q-item>
          </q-list>
        </div>
