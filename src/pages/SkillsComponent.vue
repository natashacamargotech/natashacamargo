<template>
  <q-page>
        ...
        <div class="q-pa-md" style="max-width: 350px">
          ...
          >
            ...
            <q-item clickable v-ripple>
              ...
              <q-tooltip
                >Banco de dados para armazenamento, recuperação e gerenciamento
                de informações orientadas a documentos</q-tooltip
              >
            </q-item>
    ...
    <div class="row bg-pink-2">
      <div class="col-6">
        <div href="#skills">
          <h3 class="text-center bg-pink-2">Soft Skilss</h3>
        </div>
        <q-list>
          <q-item>
            <q-item-section avatar>
              <q-icon color="black" name="star" />
            </q-item-section>
      ...
      <div class="row items-center">Avatar</div>
    </div>
  </q-page>
</template>
<script>
